...
function changeLanguage (lang) {
    ...
    if (lang == "es") {
        ...
        for (counter = 0; counter < langEs.length; counter++) {
            if (langEs[counter].tagName == "div" || langEs[counter].tagName == "p") {
        ...
        for (counter = 0; counter < langFr.length; counter++) {
            if (langFr[counter].tagName == "div" || langFr[counter].tagName == "p") {
        ...
        for (counter = 0; counter < langPtBr.length; counter++) {
            if (langPtBr[counter].tagName == "div" || langPtBr[counter].tagName == "p") {
        ...
        for (counter = 0; counter < langRu.length; counter++) {
            if (langRu[counter].tagName == "div" || langRu[counter].tagName == "p") {
        ...
        for (counter = 0; counter < langEn.length; counter++) {
            if (langEn[counter].tagName == "div" || langEn[counter].tagName == "p") {
